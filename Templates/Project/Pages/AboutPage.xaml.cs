...
public sealed partial class AboutPage : Page, INavigationAware
{
    ...
    private void ApplyLocalization()
    {
        ...
        // Feature-gated card: collapses without the updates feature
        // (XAML keeps no conditionals by design).
        UpdatesCard.Visibility = AppFeatures.Updates ? Visibility.Visible : Visibility.Collapsed;
