...
internal static class EnStrings
{
    internal static Dictionary<string, string> Strings { get; } = new()
    {
        ...
        ["HomeDescription"] = "A local-first Windows app built with WinUI 3 (.NET 10). Your documents, settings, and data stay on this machine.",
        ...
        ["HomeStatusError"] = "Last update check failed",
        ...
        ["AboutTitle"] = "About",
        ["AboutSubtitle"] = "Version, stack, license, and links for this app.",
        ["AboutAppInfo"] = "APP INFO",
        ["AboutTechnology"] = "TECHNOLOGY",
        ["AboutLicense"] = "LICENSE",
        ["AboutLinks"] = "LINKS",
        ["AboutDescription"] = "A local-first Windows app: native WinUI 3 styling, persisted settings, automatic updates, diagnostics, and a repeatable release pipeline.",
        ["AboutGithub"] = "GitHub Repository",
        ["AboutReportIssue"] = "Report an issue",
        ["AboutViewWhatsNew"] = "What's new",
        ["AboutCardName"] = "Name",
        ...
        ["AboutCardSourceDesc"] = "Star or fork the repository",
        ...
        ["WhatsNewTitle"] = "What's new in v{0}",
        ["WhatsNewFullChangelog"] = "Full changelog: {0}",
        ["FirstRunContent"] = "A local-first app for your everyday work.\n\nIncludes:\n• Settings with theme selector\n• Diagnostics and logging\n• Desktop shortcut support\n\nGet started by exploring the app!",
        ["FirstRunUpdatesVelopack"] = "Updates arrive automatically via GitHub Releases.",
        ["FirstRunUpdatesBasic"] = "Update checks run against GitHub Releases; you install new versions yourself.",
        ["FirstRunUpdatesNone"] = "This build has no automatic updates.",
        ["FirstRunUpdatesExternal"] = "Updates are handled by Windows (Store or installer feed).",
        ...
        ["SetupLocationRequired"] = "Choose a data folder to continue.",
        ["SetupLocationInvalid"] = "That folder can't be used. Choose another folder.",
