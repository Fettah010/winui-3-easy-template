...
public sealed class LocalizationService
{
    ...
    static LocalizationService()
    {
        _resources["en-US"] = new Dictionary<string, string>
        {
            ...
            ["HomeDescription"] = "A modern Windows 11 app built with WinUI 3 (.NET 10), with logging, dependency injection, settings and more.",
            ...
            ["HomeFeatSettingsDesc"] = "Theme, language and preferences — saved locally, restored on launch.",
            ["HomeFeatDiagnosticsTitle"] = "Diagnostics built in",
            ["HomeFeatDiagnosticsDesc"] = "Serilog rolling logs plus notification toasts so nothing fails silently.",
            ...
            ["HomeShipBody"] = "1. Bump Version in DevTemWinUi3.csproj  →  2. git tag v0.0.3-beta + push  →  3. CI builds, packs and publishes to GitHub Releases.",
            ["HomeShipNote"] = "Publishing scripts live in /Scripts. Update checks run only in installed builds.",
            ["AboutTitle"] = "About",
            ["AboutSubtitle"] = "Everything behind this app — version, stack, license and links.",
            ...
            ["AboutLinks"] = "LINKS",
            ["AboutDescription"] = "A production-ready starter template: Mica + native WinUI 3 styling, persisted settings, Serilog diagnostics and a clean MVVM architecture.",
        ...
        _resources["es-ES"] = new Dictionary<string, string>
        {
            ...
            ["HomeDescription"] = "Una aplicación moderna de Windows 11 construida con WinUI 3 (.NET 10), con registro, inyección de dependencias, configuración y más.",
            ...
            ["HomeFeatSettingsDesc"] = "Tema, idioma y preferencias: se guardan localmente y se restauran al iniciar.",
            ["HomeFeatDiagnosticsTitle"] = "Diagnóstico integrado",
            ["HomeFeatDiagnosticsDesc"] = "Registros rotativos de Serilog y notificaciones para que nada falle en silencio.",
            ...
            ["HomeShipBody"] = "1. Sube Version en DevTemWinUi3.csproj  →  2. git tag v0.0.3-beta + push  →  3. CI compila, empaqueta y publica en GitHub Releases.",
            ["HomeShipNote"] = "Los scripts de publicación están en /Scripts. Las comprobaciones solo funcionan en apps instaladas.",
            ["AboutTitle"] = "Acerca de",
            ["AboutSubtitle"] = "Todo sobre esta app: versión, tecnologías, licencia y enlaces.",
            ...
            ["AboutLinks"] = "ENLACES",
            ["AboutDescription"] = "Una plantilla lista para producción: estilo WinUI 3 nativo con Mica, configuración persistente, diagnósticos Serilog y una arquitectura MVVM limpia.",
        ...
        _resources["fr-FR"] = new Dictionary<string, string>
        {
            ...
            ["HomeDescription"] = "Une application moderne Windows 11 construite avec WinUI 3 (.NET 10), avec journalisation, injection de dépendances, paramètres et plus encore.",
            ...
            ["HomeFeatSettingsDesc"] = "Thème, langue et préférences — enregistrés localement, restaurés au lancement.",
            ...
            ["HomeShipBody"] = "1. Incrémentez Version dans DevTemWinUi3.csproj  →  2. git tag v0.0.3-beta + push  →  3. la CI compile, empaquette et publie sur GitHub Releases.",
            ["HomeShipNote"] = "Les scripts de publication sont dans /Scripts. La vérification ne marche que dans les apps installées.",
            ["AboutTitle"] = "À propos",
            ["AboutSubtitle"] = "Tout sur cette app : version, technologies, licence et liens.",
            ...
            ["AboutLinks"] = "LIENS",
            ["AboutDescription"] = "Un modèle prêt pour la production : style WinUI 3 natif avec Mica, paramètres persistants, diagnostics Serilog et architecture MVVM propre.",
